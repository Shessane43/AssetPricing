...
from greeks_bs_function import Greeks_BS
from functions.greeks_heston_function import Greeks_Heston

class Greeks():
    def __init__(self, option_type, model, S, K, T, r, sigma=None, theta=None, nu=None, v0=None, kappa=None, theta_heston=None, sigma_v=None, rho=None, buyer = True):
        self.S = S
        self.K = K
        self.T = T
        self.r = r
